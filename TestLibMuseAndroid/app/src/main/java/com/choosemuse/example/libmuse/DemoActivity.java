...
public class DemoActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<DemoActivity> weakActivity =
                new WeakReference<DemoActivity>(this);
...
//        elem4.setText(String.format("%6.2f", alphaBuffer[3]));
    ...
    class MuseL extends MuseListener {
        final WeakReference<DemoActivity> activityRef;

        MuseL(final WeakReference<DemoActivity> activityRef) {
    ...
    class ConnectionListener extends MuseConnectionListener {
        ...
        ConnectionListener(final WeakReference<DemoActivity> activityRef) {
            this.activityRef = activityRef;
        }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<DemoActivity> activityRef) {
            this.activityRef = activityRef;
        }
