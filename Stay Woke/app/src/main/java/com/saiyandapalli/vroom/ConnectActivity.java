...
public class ConnectActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<ConnectActivity> weakActivity =
                new WeakReference<ConnectActivity>(this);
...
//    }
    ...
    class MuseL extends MuseListener {
        final WeakReference<ConnectActivity> activityRef;

        MuseL(final WeakReference<ConnectActivity> activityRef) {
    ...
    class ConnectionListener extends MuseConnectionListener {
        ...
        ConnectionListener(final WeakReference<ConnectActivity> activityRef) {
            this.activityRef = activityRef;
        }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<ConnectActivity> activityRef) {
            this.activityRef = activityRef;
        }
